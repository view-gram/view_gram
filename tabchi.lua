...
*تعداد* : `]] .. aj .. "`"
  ...
  if msg.text:match("^[!/#]help$") and a(msg) then
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 285636389) then
      tdcli.sendMessage(285636389, 0, 1, "من برای شمام", 1, "html")
...
راهنمای دستورات : 
برای دیدن راهنمای کامل و توضیح هر دستور به این ایدی مراجعه کنید:
